...
// validated before the first forge call by internal/changeset (entry cap,
// path shape, and on a repository-declared image no CI definitions), under
// rules with no deny list; a refusal fails the attempt changeset_rejected.
//
