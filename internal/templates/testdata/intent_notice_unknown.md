<!-- patchy:notice patchy/target-1 command-4418 -->
`/patchy ship` is not a command patchy knows on an intent issue.

Commands go on the first line of a comment. Here you can use:
