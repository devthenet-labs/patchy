Part of devthenet-labs/intents#1

Fixes `# 3`, closes `owner/repo# 4` \<!-- x --> for `@ octocat`, resolves `https://ghe.example.com/acme/app/issues/ 12` (`closes # 12`, `fixes acme/app# 3`)
