...
patchy parked this finding for a human rather than run it on another image, because the operator set `onReject: handoff`. Comment `/patchy approve` to run it in the default runner image.
